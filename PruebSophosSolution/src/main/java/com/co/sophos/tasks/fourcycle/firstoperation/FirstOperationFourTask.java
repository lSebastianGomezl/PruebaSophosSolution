package com.co.sophos.tasks.fourcycle.firstoperation;
...
public class FirstOperationFourTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {

        actor.attemptsTo(
                Click.on(FourCycleInterface.SELECT_RESULT),
                Click.on(FourCycleInterface.RESULT_1610)
        );
        /*
    ...
    public static FirstOperationFourTask result(){
        return instrumented(FirstOperationFourTask.class);
    }
}
