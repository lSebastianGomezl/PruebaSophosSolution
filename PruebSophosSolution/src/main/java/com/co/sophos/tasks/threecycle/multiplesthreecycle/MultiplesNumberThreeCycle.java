...
public class MultiplesNumberThreeCycle implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        for (int i = 0 ; i < multiplesFour.size();i++){
            System.out.println("Numeros " + multiplesFour.get(i));
    ...
    public static MultiplesNumberThreeCycle on(){
        return instrumented(MultiplesNumberThreeCycle.class);
    }
}
