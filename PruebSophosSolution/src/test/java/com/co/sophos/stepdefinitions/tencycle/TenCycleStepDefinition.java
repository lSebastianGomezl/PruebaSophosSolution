package com.co.sophos.stepdefinitions.tencycle;

import com.co.sophos.questions.ninecycle.NineCycleQuestion;
import com.co.sophos.questions.tencycle.TenCycleQuestion;
...
import com.co.sophos.tasks.tencycle.indicatedfigureten.IndiquedMonkeyTenTask;
import com.co.sophos.tasks.tencycle.operatinfirtsten.OperationFirstTenTask;
import com.co.sophos.tasks.tencycle.operationsecondten.operationsecondeight.OperationSecondTen;
import com.co.sophos.tasks.tencycle.writeyten.WriteLetteryTask;
...
public class TenCycleStepDefinition {
    ...
    public void heInsertsTheResultOfTheOperation() {
        Sebastian.wasAbleTo(
                OperationFirstTenTask.on()
        );
    }

    @When("^he puts the number of existing monkey$")
    public void hePutsTheNumberOfExistingMonkey() {
        Sebastian.wasAbleTo(
                IndiquedMonkeyTenTask.on()
        );
    }

    @When("^he puts quantity of the letter y$")
    public void hePutsQuantityOfTheLetterY() {
        Sebastian.wasAbleTo(
                WriteLetteryTask.on()
        );
    }

    @When("^he introduces the result of the operation$")
    public void heIntroducesTheResultOfTheOperation() {
        Sebastian.wasAbleTo(
                OperationSecondTen.on()
        );
    }
    ...
    @Then("^you should see that éxito$")
    public void youShouldSeeThatÉxito() {
        System.out.println("El titulo que el actor el titulo éxito : \n " + TenCycleQuestion.ninetCycleSuccessful().answeredBy(Sebastian));
