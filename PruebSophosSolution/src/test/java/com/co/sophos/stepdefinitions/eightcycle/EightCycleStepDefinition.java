package com.co.sophos.stepdefinitions.eightcycle;
...
public class EightCycleStepDefinition {
    ...
    @When("^he puts the number of existing mice$")
    public void hePutsTheNumberOfExistingMice() {
        Sebastian.wasAbleTo(
    ...
    public void youShouldSeeThatHeSAtNineOutOfTen() {
        System.out.println("El titulo que el actor el titulo Se encuentra en el ciclo 9 de 10 : \n " + EightCycleQuestion.eightCycleSuccessful().answeredBy(Sebastian));
    }
