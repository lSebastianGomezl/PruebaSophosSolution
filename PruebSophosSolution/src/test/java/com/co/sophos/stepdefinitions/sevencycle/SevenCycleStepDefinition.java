package com.co.sophos.stepdefinitions.sevencycle;
...
public class SevenCycleStepDefinition {
    ...
    @When("^he writes how many hedgehogs there are$")
    public void heWritesHowManyHedgehogsThereAre() {
        Sebastian.wasAbleTo(
    ...
    @Then("^he should see that he's in the seven out of ten$")
    public void heShouldSeeThatHeSInTheSevenOutOfTen() {
        System.out.println("El titulo que el actor el titulo Se encuentra en el ciclo 8 de 10 : \n " + SevenCycleQuestion.sevenCycleSuccessful().answeredBy(Sebastian));
